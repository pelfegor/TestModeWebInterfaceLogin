# TestModeWebInterfaceLogin [![Build status](https://ci.appveyor.com/api/projects/status/58d1i7ekhegm4lrs?svg=true)](https://ci.appveyor.com/project/pelfegor/testmodewebinterfacelogin)
